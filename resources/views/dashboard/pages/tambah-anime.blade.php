        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Tambah Anime</div>
                </div>
            </div>

            <div class="section-body">
                <h2 class="section-title">Tambah Anime</h2>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="/tambah-anime" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <input type="text"
                                                class="form-control" id="slug" name="slug" readonly value="{{ old('slug') }}">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <input type="number"
                                                class="form-control @error('jum_episodes')
                                                    is-invalid
                                                @enderror" id="title" name="jum_episodes" required value="{{ old('jum_episodes') }}">
                                                @error('jum_episodes')
                                                <div class="alert alert-danger alert-dismissible show fade">
                                                    <div class="alert-body">
                                                        <button class="close"
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <input type="text"
                                                class="form-control @error('durasi')
                                                    is-invalid
                                                @enderror" id="title" name="durasi" required value="{{ old('durasi') }}">
                                                @error('durasi')
                                                <div class="alert alert-danger alert-dismissible show fade">
                                                    <div class="alert-body">
                                                        <button class="close"
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <textarea class="summernote-simple" name="sinopsis" required>{{ old('sinopsis') }}</textarea>
                                            @error('sinopsis')
                                                    <div class="alert alert-danger alert-dismissible show fade">
                                                        <div class="alert-body">
                                                            <button class="close"
